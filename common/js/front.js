...
var scheduleRegist = (function($){
	...
	var inputVal = function(val){
		...
		$schedule.find("#sTitle").val(data.title);
		$schedule.find("#start-date").val(data.start);
		$schedule.find("#end-date").val(data.end);
